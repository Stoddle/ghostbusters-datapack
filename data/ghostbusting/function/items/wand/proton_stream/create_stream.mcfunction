...
execute positioned ~ ~-0.4 ~ run summon area_effect_cloud ^-0.5 ^ ^0.5 {Tags:["protonStream","stream","newStream"],Duration:20}
...
function ghostbusting:items/wand/proton_stream/effect